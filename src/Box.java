...
//        Box box;
//        System.out.println("Wywołania Box ze współrzędnymi (25,25) i (50,50)");
//        box = new Box(25,25,50,50);
//        box.printBox();
//
//        System.out.println("\nWywołania Box z punktami  (10,10) i (20,20)");
//        box = new Box(new Point(10,10), new Point(20,20));
//        box.printBox();
//
//        System.out.println("\nWywołania Box z punktem  (10,10) o szerokośći 50 i wysokosći 50)");
//        box = new Box(new Point(10,10), new Point(50,50));
//        box.printBox();
//    }
//    }
